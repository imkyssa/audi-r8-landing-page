        ...
        <nav>
            <div className="nav-left">
                ...
                <ul className="nav-items">
                    <li className="nav-item">Modeller</li>
                    <li className="nav-item">Elektromobilite</li>
                    <li className="nav-item">Audi Dünyası</li>
                </ul>
            </div>
            <ul className="nav-items">
                <li className="nav-item">R5</li>
                <li className="nav-item">R6</li>
                <li className="nav-item">R7</li>
            </ul>
        </nav>
    )
}
